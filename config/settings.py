"""
Configuración del proyecto hoteltickets.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-cambia-en-produccion-xxxxxxxxxxxxxxxxxxxx')
DEBUG = config('DEBUG', default=True, cast=bool)
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1', cast=Csv())

# URL pública (usada en los correos para enlaces clicables)
SITE_URL = config('SITE_URL', default='http://127.0.0.1:8000')

# CSRF para producción detrás de HTTPS
...
# Base de datos: SQLite por defecto, PostgreSQL si se define DATABASE_URL
...
LOGOUT_REDIRECT_URL = 'ticket_publico'
...
# Mensajes flash con clases Bootstrap
